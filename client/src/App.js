    ...
    <div>
     ...
     <Grid item>
      ...
      {screen === 'mobile' && (
             ...
             <Button onClick={handleEnrollButtonClick} sx={{ width:"400px",textTransform: 'capitalize', backgroundColor: "#8ea7d1", marginLeft:"13px", marginTop:"25px", color:"white" }}>Enroll Now</Button>
           </Grid>
